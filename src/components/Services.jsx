...
const items = [
  {
    ...
    Icon: () => (
      <svg viewBox="0 0 120 120" className="h-16 w-16 md:h-20 md:w-20 fill-[#0E1B25]">
  ...
  },
  {
    ...
    Icon: () => (
      <svg viewBox="0 0 120 120" className="h-16 w-16 md:h-20 md:w-20 fill-[#0E1B25]">
        ...
        <path d="M50 25a35 35 0 0 1 35 35H50Z" className="fill-[#0E1B25]" />
      </svg>
    ),
  },
  {
    ...
    Icon: () => <Logo className="w-16 h-16 text-black/80" />,
  },
];
...
export default function Services() {
  ...
  return (
    <section className="bg-[#F7F0EF] text-[#2B2A29]">
      <div className="mx-auto max-w-7xl px-4 md:px-8 py-16 md:pb-24 md:pt-10">
        {/* Heading */}
        <h2 className="text-center font-serif text-5xl md:text-7xl tracking-tight text-[#2B3A4A]">
          Services
        </h2>
        <p className="mx-auto mt-6 max-w-3xl text-center text-base md:text-lg leading-relaxed text-[#4A5C4C]">
        ...
        <div className="mt-16 hidden md:grid grid-cols-3 gap-12 services">
          {items.map(({ title, desc, Icon }) => (
            <article key={title} className="flex flex-col items-center text-center">
              <Icon />
              <h3 className="mt-6 font-serif text-2xl md:text-3xl tracking-tight">{title}</h3>
              <p className="mt-3 text-base leading-relaxed text-[#2B2A29]/80 max-w-xs">{desc}</p>
            </article>
          ))}
        </div>
